...
const ModalDescription = ({ data, f }) => {
  ...
  return (
    <div>
      <div className="  fixed top-20 left-0 lg:right-0  z-50 w-full lg:w-3/4 mx-auto ">
        <div className=" p-4">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 space-y-6">
              <div className=" my-4 mx-4 cardMaxWPorta cardModal rounded-2xl">
                <div className="imgCardPorta ">
                  <div className="slider">
                    <ul className="flex flex-col lg:flex-row">
                      {data.img.map((imagen) => (
                        <li>
                          <img className="imgP" src={imagen} alt={data.name} />
                        </li>
                      ))}
                    </ul>
                  </div>
                ...
                <div
                  className="infoCardPorta text-center"
                  onClick={() => {
                    f(data);
                  }}
                >
            ...
            <div className="flex justify-end p-6  ">
              ...
              <button
                className="btnCv rounded-lg px-4 py-1 flex items-center justify-around "
                onClick={() => {
                  f();
                }}
              >
