    ...
    <nav className="fixed w-full z-10  px-2 sm:px-4 py-  colorNav">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div
          ...
          id="navbar-default"
        >
          <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-[#212121] md:dark:bg-transparent dark:border-gray-700">
            <li>
              <a href="#home" onClick={() => {
              setBtnNav(false);
            }}
